...
import com.jackluan.bigflag.provider.dto.response.wechat.WeChatOaUserInfoDto;
...
public class LoginServiceImpl implements ILoginService {
    ...
    public String processMsg(HttpServletRequest request) {
        ...
        if (WeChatConstant.REQ_MESSAGE_TYPE_EVENT.equals(msgType)) {
            ...
            String accessToken = weChatUtils.getAccessToken(WeChatConstant.OA);
    ...
    public String processAppMsg(HttpServletRequest request) {
        ...
        if (StringUtils.isEmpty(CacheObject.weChatCache.get(SystemConstant.WE_CHAT_APP_FILE_ID_KEY))){
        ...
        String jsonPhoto = String.format(WeChatConstant.APP_PHOTO_MSG_DATA_JSON, requestMap.get(WeChatConstant.APP_FROM_USER_NAME), CacheObject.weChatCache.get(SystemConstant.WE_CHAT_APP_FILE_ID_KEY));
        String accessToken = weChatUtils.getAccessToken(WeChatConstant.APP);
