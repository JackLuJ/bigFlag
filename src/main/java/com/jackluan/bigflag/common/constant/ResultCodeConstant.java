...
public class ResultCodeConstant {
    ...
    public static final String NOT_LOGIN = "SYS000001";
    ...
    public static final String UPDATE_USER_FAILED = "USER00002";
    ...
    public static final String CREATE_FLAG_FAILED = "FLAG00001";
    ...
    public static final String UPDATE_APPROVER_FAILED = "FLAG00005";

    public static final String FIND_FLAG_FAILED = "FLAG00006";

    public static final String FLAG_UPDATE_TYPE_NOT_SET = "FLAG00007";

    public static final String INCREASE_FLAG_PERFORMANCE_FAILED = "FLAG00008";

    public static final String HAS_BEAN_APPROVER = "FLAG00009";

    public static final String APPROVER_NOT_EXITS = "FLAG00010";
    ...
    public static final String CREATE_FILE_FAILED = "FILE00001";

    public static final String CREATE_FILE_GROUP_FAILED = "FILE00002";

    public static final String CREATE_FILE_GROUP_FILE_EMPTY_FAILED = "FILE00003";

    public static final String CREATE_FILE_GROUP_FILE_NOT_EXIST_FAILED = "FILE00004";
    ...
    public static final String CREATE_SIGN_TRACE_FAILED = "SIGN00002";
